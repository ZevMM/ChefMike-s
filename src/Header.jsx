    ...
    return (
      ...
      <div style={{width:"100%", height:"10%", background:"rgb(207, 226, 243)", display:"flex",
        ...
        <div style={{ flexGrow:"1", flexBasis:"0"}}>
            ...
            <div style = {{border: "2px solid black", borderRadius: "15px", padding:"5px", display:"flex", flexDirection:"row"}} onClick={() => setModals({...modals, leaderboard: !modals.leaderboard})}
                onBlur={(e) => {
        ...
        <div style={{ flexGrow:"1", flexBasis:"0", display:"flex", maxHeight:"100%", flexDirection:"row"}}>
            ...
            <div style={{height:"50%"}} onClick={() => setModals({...modals, help: !modals.help})}
                onBlur={(e) => {
                    if (e.relatedTarget && e.relatedTarget.className == "modal") {
                        return
                    }
            ...
            <div style={{height:"50%", margin:"3px"}} onClick={() => setModals({...modals, settings: !modals.settings})}
                onBlur={(e) => {
                    if (e.relatedTarget && e.relatedTarget.className == "modal") {
                        return
                    }
            ...
            <div style={{height:"50%"}} onClick={() => setModals({...modals, profile: !modals.profile})}
                onBlur={(e) => {
                    if (e.relatedTarget && e.relatedTarget.className == "modal") {
                        return
                    }
